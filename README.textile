...
Bootstrap a Rails 3 app - This is very much a work in progress a this point...
...
h2. What does this thing have in it
  ...
  * "carrierwave":http://carrierwave.rubyforge.org/ Classier solution for file uploads in Ruby for Rack, Rails, Merb and Sinatra
...
h3. TODO
  ...
  finish converting the "HTML5 Boilerplate":http://html5boilerplate.com
  I know there is already a conversion to Haml and Sass, but I don't want to have to use Compas (nothing personal)
